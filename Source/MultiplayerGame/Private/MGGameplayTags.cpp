...
FMGGameplayTags FMGGameplayTags::GameplayTags;

void FMGGameplayTags::InitializeNativeTags()
{
...
void FMGGameplayTags::AddAllTags(UGameplayTagsManager& Manager)
{
...
void FMGGameplayTags::AddTag(FGameplayTag& OutTag, const ANSICHAR* TagName, const ANSICHAR* TagComment)
{
	OutTag = UGameplayTagsManager::Get().AddNativeGameplayTag(FName(TagName), FString(TEXT("(Native) ")) + FString(TagComment));
}

void FMGGameplayTags::AddMovementModeTag(FGameplayTag& OutTag, const ANSICHAR* TagName, uint8 MovementMode)
{
	AddTag(OutTag, TagName, "Character movement mode tag.");
	GameplayTags.MovementModeTagMap.Add(MovementMode, OutTag);
}

FGameplayTag FMGGameplayTags::FindTagByString(FString TagString, bool bMatchPartialString)
{
